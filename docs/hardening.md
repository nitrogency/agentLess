...
- Configuring automatic, unattended system updates.
...
- Installing and configuring ufw. By default all incoming traffic is blocked except for the set SSH port (default 4222) and the web service port (default 8443). **By default, all outgoing traffic is allowed. You should change this according to your environment if necessary.**
